...
from choco.problems.facility_location_problem import FacilityLocationProblem, generate_flp
...
flp_problems_pkg, flp_configs_pkg = generate_flp(1, [(1, 2)], 1, 20)

problems_pkg = list(itertools.chain(enumerate(flp_problems_pkg)))
            ...
            for solver in solvers:
                ...
                with ProcessPoolExecutor(max_workers=num_processes) as executor:
                    ...
                    for future, prb, pkid, pbid, layer, solver in futures:
                        prb: FacilityLocationProblem = prb
